...
export const showSuccessMessage = (linkProps:LinkProps) => {
    ...
    vscode.window.showInformationMessage(header, MORE_INFO_BUTTON).then((button)=>{
...
export const showErrorMessage = (errorMessage:string| undefined, linkProps:LinkProps) => {
...
function addLinkToEnvironment(button: string | undefined, linkProps: LinkProps) {
